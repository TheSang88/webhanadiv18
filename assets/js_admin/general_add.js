...
function kiemtrama()
	...
	if($('#form-bk').validationEngine('validate')){
		...
		$.ajax({
			...
			url: base_url() + 'wpadmin/alias/checkAdd_code',
			...
			success:function(result){
				...
				if(result.check == true){
					...
					$('#error-alias2').append('<div class="alert-danger">Mã đã tồn tại ! Vui lòng nhập mã khác</div>');
...
function createItem()
	...
	if($('#form-bk').validationEngine('validate')){
		...
		$.ajax({
			...
			url: base_url() + 'wpadmin/alias/checkAdd',
...
function editCatItem(){
	...
	if($('#form-bk').validationEngine('validate')){
		...
		$.ajax({
			...
			url: base_url() + 'wpadmin/alias/checkCatEdit',
...
function editItem(){
	...
	if($('#form-bk').validationEngine('validate')){
		...
		$.ajax({
			...
			url: base_url() + 'wpadmin/alias/checkEdit',
