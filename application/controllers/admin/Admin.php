...
//Add Category document
...

        {
            ...
            if(isset($_POST['addnews'])) {
                ...
                redirect(base_url('wpadmin/admin/listDoc'));
        ...
        $data['btn_name']='Thêm';
         ...
         if (isset($_POST['addnews'])) {
           ...
           //
            ...
            redirect(base_url().'wpadmin/admin/setup_product');
    ...
    { 
       ...
       $data = array();
        ...
        $this->LoadHeaderAdmin($data);
         ...
         $this->load->view('admin/system/sitemap_view',$data );
       ...
       if($id !=null){
        ...
        if($id_edit!=null){
         ...
         if (isset($_POST['addnews'])) {
            ...
            redirect(base_url().'wpadmin/admin/setup_wiget');
