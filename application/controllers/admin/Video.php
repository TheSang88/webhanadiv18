...
//    ======================================================================================================================
    public function listAll()
    {
		...
		if($this->input->get()){
            ...
            $config['base_url']             = base_url('wpadmin/video/listAll?name='
                . $this->input->get('name')
                . '&cate=' . $this->input->get('cate')
                . '&view=' . $this->input->get('view')
                . '&lang=' . $this->language
            ...
            $config['base_url'] = base_url('wpadmin/video/listAll');
    ...
    public function add($id_edit=null)
    {
		...
		if (isset($_POST['addnews'])) {
            ...
            redirect(base_url('wpadmin/video/listAll'));
        }
...
//******* danh muc ********************************************************
	...
	public function cat_add($id_edit=null)
    {
        ...
        if (isset($_POST['addnews'])) {
            ...
            redirect(base_url('wpadmin/video/categories'));
        }
        $data['cate'] = $this->m_video->get_data('video_category',array(
            'lang' => $this->language
        ),array('sort'=>'asc'));
