...

    {
...

        {
            ...
            if($this->input->get()){
                ...
                $config['base_url']             = base_url('wpadmin/news/newslist?name='
            ...
            $data['show_coupon'] = $this->news_model->getFirstRowWhere('config_checkpro',array('type' => 'news','field' => 'coupon',));   
            ...
            if (isset($_POST['addnews'])) {
				...
				if (!empty($_POST['edit'])){
					...
					$id = $this->news_model->Update_where('news', array('id'=>$id_edit), $arr);
                      ...
                      $this->news_model->Update_where('news',array('id' => $id_edit),array(
                    ...
                    $this->news_model->Update_where('news',array('id' => $id),array(
                ...
                redirect(base_url('wpadmin/news/newslist'));
...
//************ Danh mục **********************************************************************
...

        {
            ...
            if(isset($_POST['addnews'])) {
                ...
                redirect(base_url('wpadmin/news/categories'));
