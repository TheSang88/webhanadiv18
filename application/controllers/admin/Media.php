...
//    ======================================================================================================================
...

    {
		...
		if($this->input->get()){
            ...
            $config['base_url']             = base_url('wpadmin/media/listAll?name='
            ...
            $config['base_url'] = base_url('wpadmin/media/listAll');
...

    {
		...
		if (isset($_POST['addnews'])) {
            ...
            $arr = array(
                ...
                'tinhthanh'          => $this->input->post('province'),
                'huyen'          => $this->input->post('district'),
                'focus'          => $this->input->post('focus'),

                  'linkmap'          => $this->input->post('linkmap'),
            ...
            redirect(base_url('wpadmin/media/listAll'));
...
//******* danh muc ********************************************************
...

    {
        ...
        if (isset($_POST['addnews'])) {
            ...
            redirect(base_url('wpadmin/media/categories'));
