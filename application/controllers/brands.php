...
class Brands extends MY_Controller
{
    function __construct()
    {
        ...
        $this->load->model('f_brandmodel'); $this->load->model('f_productmodel');
     ...
     public function brand_bycategory($alias){
        ...
        $config['total_rows'] = $this->f_productmodel->count_ProbyCate_thuonghieu($current->id);
        ...
        $data['lists'] = $lists = $this->f_productmodel->thuonghieu_mod($current->id,$order,$config['per_page'],$this->input->get('per_page'));
