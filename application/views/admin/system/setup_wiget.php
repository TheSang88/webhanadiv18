...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/admin/setup_wiget')?>">Cấu hình widget</a></li>
                              ...
                              <td class="text-center">
                                 ...
                                 <div class="btn-group">
                                  ...
                                  class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil"></i></a>
                                    ...
                                    <a href="<?= base_url('wpadmin/admin/xoa_config_banner/' .$bn->id) ?>"
                  ...
                  // them nút hiện thị
                      ...
                      function getModal_wiget_show() {
                          ...
                          $.ajax({
                              ...
                              url: base_url() + 'wpadmin/admin/popupdata_wiget',
