...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/admin/setup_product')?>">Cấu hình thuộc tính sản phẩm</a></li>
                                    ...
                                    <td class="text-center">
                                       ...
                                       <div class="btn-group">
                                        ...
                                        class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil"></i></a>
                                          ...
                                          <a href="<?= base_url('wpadmin/admin/xoa_thuoctinh/' . $key) ?>"
                                    ...
                                    <td class="text-center">
                                       ...
                                       <div class="btn-group">
                                        ...
                                        class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil"></i></a>
                                          ...
                                          <a href="<?= base_url('wpadmin/admin/xoa_showbut/' .$v->id) ?>"
...
<script>
    ...
    function getModal_attpro() {
        ...
        $.ajax({
            ...
            url: base_url() + 'wpadmin/admin/popupdata_attpro',
    ...
    function getModal_button_show() {
        ...
        $.ajax({
            ...
            url: base_url() + 'wpadmin/admin/popupdata_butshow',
