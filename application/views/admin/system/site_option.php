...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/site_option')?>">Cấu hình</a></li>
							...
							<div class="col-sm-12">
								...
								<?php
									...
									if(file_exists(@$row->site_logo)){
										...
										echo '<img style="width:150px" src="'.base_url($row->site_logo).'" id="image_review">';
...
<?php } ?>
						...
						<div class="form-group ">
			                ...
			                <label  class="col-sm-12">Thiết lập File SiteMap.xml</label>

			                <div class="col-sm-7">

			                    <a href="<?= base_url('wpadmin/admin/sitemap_view') ?>" class="btn btn-info">Thiết lập SiteMap</a>
