...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/imageupload/banners')?>"> Danh sách Banner</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="<?= base_url('wpadmin/imageupload/addbanner')?>" class="btn btn-success btn-sm">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('wpadmin/imageupload/deletes')?>">
						...
						<tr>
							...
							<td class="text-center">
								...
								<a class="btn btn-xs btn-default"
								   ...
								   href="<?= base_url('wpadmin/imageupload/edit/' . $v->id) ?>"><i
								...
								<a class="btn btn-xs btn-danger"
								   ...
								   href="<?= base_url('wpadmin/imageupload/delete/' . $v->id) ?>" title="Xóa"
