...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/attribute/listColor')?>">Danh sách màu sắc</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="<?= base_url('wpadmin/attribute/addcolor')?>" class="btn btn-success btn-sm">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('wpadmin/attribute/deletes_color_category')?>">
						...
						<tr>
							...
							<td class="text-center">
								...
								<a class="btn btn-xs btn-default"
								   ...
								   href="<?= base_url('wpadmin/attribute/editcolor/' . $v->id) ?>"><i

										class="fa fa-pencil"></i> </a>

								<a class="btn btn-xs btn-danger"

								   href="<?= base_url('wpadmin/attribute/deletecolorcategory/' . $v->id) ?>" title="Xóa"
