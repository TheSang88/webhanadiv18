...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/attribute/categories')?>">Danh sách thuộc tính</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <a href="<?= base_url('wpadmin/attribute/cat_add')?>" class="btn btn-success btn-sm">
        ...
        <!-- /.box-header -->
        <div class="box-body">
			<form name="formbk" method="post" action="<?=base_url('wpadmin/attribute/deletes_category')?>">
						...
						<tr>
							...
							<td class="text-center">
								<a class="btn btn-xs btn-default"
								   href="<?= base_url('wpadmin/attribute/cat_edit/' . $v->id) ?>"><i
										class="fa fa-pencil"></i> </a>
								<a class="btn btn-xs btn-danger"
								   href="<?= base_url('wpadmin/attribute/deletecategory/' . $v->id) ?>" title="Xóa"
