...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/attribute/categories')?>">Nhóm thuộc tính</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <a href="<?= base_url('wpadmin/attribute/add')?>" class="btn btn-success btn-sm">
        ...
        <!-- /.box-header -->
        <div class="box-body">
			<form name="formbk" method="post" action="<?=base_url('wpadmin/attribute/deletes')?>">
						...
						<tr>
							...
							<td class="text-center">
								<a class="btn btn-xs btn-default"
								   href="<?= base_url('wpadmin/attribute/edit/' . $v->id) ?>"><i
										class="fa fa-pencil"></i> </a>
								<a class="btn btn-xs btn-danger"
								   href="<?= base_url('wpadmin/attribute/delete/' . $v->id) ?>" title="Xóa"
