                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="pull-right">
                                <a href="<?=base_url('wpadmin/attribute/add')?>">
                                ...
                                <?php foreach($attris as $attri) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?=site_url('wpadmin/attribute/edit/'.$attri->id)?>" class="btn btn-xs btn-default" title="S?a"><i class="fa fa-pencil"></i></a>
                                            <a href="<?=site_url('wpadmin/attribute/delete/'.$attri->id)?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-xs btn-danger" title="Xóa" style="color: #fff"><i class="fa fa-times"></i> </a>
                                        </td>
                                    </tr>
                                <?php endforeach;?>
                                </tbody>
...
<script type="text/javascript">
            ...
            $('.view_color_sale').click(function(){
                ...
                //alert(id);
                $.ajax({
                    url: baseurl+"wpadmin/attribute/update_attr_view",
                    type: 'POST',
                    dataType: 'json',
                    data: form_data,
                    success: function (rs) {
