...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/users/listAll')?>">Danh sách thành viên</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="<?= base_url('wpadmin/users/add')?>" class="hidden btn btn-success btn-sm">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('wpadmin/users/deletes')?>">
						...
						<tr>
							...
							<td class="text-center">
								...
								<a class="btn btn-xs btn-danger"
								   ...
								   href="<?= base_url('wpadmin/users/delete/' . $v->id) ?>" title="Xóa"
    ...
    <div class="container-fluid">
        ...
        <div class="row breadcrumb">
            ...
            <div class="col-lg-6 text-right">
                ...
                <a href="<?=base_url()?>wpadmin/user/add" class="btn btn-success btn-xs">
        ...
        <div>
                ...
                <form name="frmUser" method="post" action="<?=base_url('wpadmin/users/delete')?>">
                                    ...
                                    <?php foreach($user as $userArray){ ?>
                                        ...
                                        <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>">
                                            ...
                                            <td class="detail_list">
                                                ...
                                                <a class="menu" href="<?php echo base_url() ?>wpadmin/users/add/<?php echo $userArray->id; ?>" title="<?php echo $this->lang->line('edit_tip'); ?>">
                                            ...
                                            <td class="detail_list" style="text-align:center;">
                                                ...
                                                <?php if($userArray->use_status == 1){ ?>
                                                    ...
                                                    <img src="<?php echo base_url(); ?>assets/img/admin/active.png" <?php if($userLogined != $userArray->id){ ?> onclick="ActionStatus('<?=base_url('wpadmin/users/deactive/'.$userArray->id)?>')" style="cursor:pointer;" <?php } ?> border="0" title="<?php echo $this->lang->line('deactive_tip'); ?>" />

                                                <?php }else{ ?>

                                                    <img src="<?php echo base_url(); ?>assets/img/admin/deactive.png" <?php if($userLogined != $userArray->id){ ?> onclick="ActionStatus('<?=base_url('wpadmin/users/active/'.$userArray->id)?>')" style="cursor:pointer;" <?php } ?> border="0" title="<?php echo $this->lang->line('active_tip'); ?>" />
