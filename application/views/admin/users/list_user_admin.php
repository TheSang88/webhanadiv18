...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/users/listuser_admin')?>">Danh sách thành viên quản trị</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header"> 
            ...
            <a href="<?= base_url('wpadmin/users/add_users')?>" class=" btn btn-success btn-sm">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								...
								<a class="btn btn-xs label-success" href="<?= base_url('wpadmin/admin/permission/1') ?>" title="cap nhat"><i class="fa fa-gears"></i> </a>
						...
						<tr>
							...
							<td class="text-center">
								...
								<a class="btn btn-xs label-success"
								   ...
								   href="<?= base_url('wpadmin/admin/permission/' . $v->id) ?>" title="Xóa"
