<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/emails/emails')?>"> Danh sách email</a></li>
...
<section class="content">
    <!-- Page Heading -->
    <div class="box">
		<form name="formbk" class="form-horizontal" role="form" id="mail_list" method="POST" action="<?=base_url('wpadmin/email/mail_coupon')?>" enctype="multipart/form-data">
					...
					<tr>
						...
						<td class="text-center">
							<a class="btn btn-xs btn-danger"
							   href="<?= base_url('wpadmin/email/delete/' . $v->id) ?>" title="Xóa"
