...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/pages/pagelist')?>">Trang nội dung</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="<?= base_url('wpadmin/pages/addpage')?>" class="btn btn-success btn-sm">
        ...
        <div class="box-body">
            ...
            <form name="formbk" method="post" action="<?=base_url('wpadmin/pages/deletes')?>">
                ...
                <table id="myTable2" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <?php } ?>
                            ...
                            <td><a href="<?= base_url('wpadmin/pages/edit/'.$v->id)?>"><?= @$v->name?></a></td>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?= base_url('wpadmin/pages/edit/'.$v->id)?>" class="btn btn-xs btn-default">
                                ...
                                <a href="<?= base_url('wpadmin/pages/delete/'.$v->id)?>" class="btn btn-xs btn-danger">
