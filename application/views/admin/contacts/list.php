...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/contact/contacts')?>"> Danh sách liên hệ</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('wpadmin/contact/deletes')?>">
					 ...
					 <tbody>
						...
						<tr>
							...
							<td class="text-center">
								...
								<a href="<?= base_url('wpadmin/contact/delete/'.$v->id)?>"
...
<script>
	...
	function getModal(id,div) {
		...
		$.ajax({
			...
			url: base_url() + 'wpadmin/contact/popupdata',
