...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/news/categories')?>">Danh sách danh mục tin</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="<?= base_url('wpadmin/news/addnews')?>" class="btn btn-success btn-sm">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('wpadmin/news/deletes')?>">
                ...
                <table id="example" class="table table-bordered table-striped">
					...
					<thead>
                        ...
                        <tr>
							...
							<th width="7%" class=" no-sort">Người đăng</th>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<input type="number" onchange="update_sort($(this))" value="<?= @$v->sort ?>" data-placement='news'	   data-item='<?= @$v->id; ?>' style="width: 55px">	

							</td>

							<td><a href="<?= base_url('wpadmin/news/edit/' . $v->id) ?>"><?= @$v->title ?></a></td>
							...
							<td>
                                ...
                                <div data-toggle="tooltip" data-placement="news" title="<?=@$show_focus->name ?>"
                                   ...
                                   <!--   <div data-toggle="tooltip" data-placement="news" title="<?=@$show_coupon->name ?>"
							...
							<td class="text-center">
								...
								<a href="<?=base_url(''.$v->alias.'.html')?>" class="btn btn-xs btn-default" target="_blank" title="Xem trước">
								...
								<a class="btn btn-xs btn-default"
								   ...
								   href="<?= base_url('wpadmin/news/edit/' . $v->id) ?>"><i

										class="fa fa-pencil"></i> </a>

								<a class="btn btn-xs btn-danger"

								   href="<?= base_url('wpadmin/news/delete/' . $v->id) ?>" title="Xóa"
