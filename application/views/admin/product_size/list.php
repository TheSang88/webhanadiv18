...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/aitribute/listOption')?>">Danh sách kích thước</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <a href="<?= base_url('wpadmin/aitribute/addoption')?>" class="btn btn-success btn-sm">
        ...
        <!-- /.box-header -->
        <div class="box-body">
			<form name="formbk" method="post" action="<?=base_url('wpadmin/attribute/deletes_option_category')?>">
						...
						<tr>
							...
							<td class="text-center">
								<a class="btn btn-xs btn-default"
								   href="<?= base_url('wpadmin/attribute/editoption/' . $v->id) ?>"><i
										class="fa fa-pencil"></i> </a>
								<a class="btn btn-xs btn-danger"
								   href="<?= base_url('wpadmin/attribute/deleteopioncategory/' . $v->id) ?>" title="Xóa"
