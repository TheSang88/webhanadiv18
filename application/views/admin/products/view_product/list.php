...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/product/categories')?>">Danh mục sản phẩm</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <a href="<?= base_url('wpadmin/product/add')?>" class="btn btn-success btn-sm">
        ...
        <div class="box-body">
			<div class="col-sm-12" >
				...
				<form action="" method="get">
					<div class="form-group row">
						...
						<div class="col-sm-3">
							<select name="cate" id="cate" class="input-sm form-control">
			...
			<form name="formbk" method="post" action="<?=base_url('wpadmin/product/deletes')?>">
                <table id="example" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td class="todo-list"><a href="<?= base_url('wpadmin/product/edit/' . $v->id) ?>" title="Sửa dự án">
                                <?= @$v->name ?>
                                </a>
								<div class="tools">
									<a href="<?=base_url(''.$v->alias.'.html')?>" target="_blank" >Xem trước</a>
									<a href="<?= base_url('wpadmin/product/images/' . $v->id) ?>">Thêm ảnh</a>
								</div>
							</td>
							<td><?= @$v->cat_name->name ?></td>
							<td style="text-align: center;"><?php if($v->trangthai == 1):?>Ẩn<?php else:?>Hiện<?php endif?>
</td>
							<td>
							...
							<td class="text-center">
							 ...
							 <a href="<?= base_url('wpadmin/product/images/' . $v->id) ?>" class="btn btn-xs btn-default" title="Ảnh dự án"><i class="fa fa-image"></i></a>
