            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                  ...
                  <ul class="nav nav-tabs">
                     ...
                     <li class="" ><a data-toggle="tab" href="#menu1">Dữ liệu</a></li>
               ...
               <div class="panel-body">
                  <div class="tab-content">
                     <div id="home" class="tab-pane fade in active">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="col-sm-12 form-text">Mã sản phẩm :</label>
                                 <div class="col-sm-12">
                                    <input type="text"  class="validate[required] form-control input-sm " name="code"
                 ...
                 <?php if (isset($thuoctinh)&&count($thuoctinh)>0) {
                     ...
                     <div id="menu1" class="tab-pane fade">
                        ...
                        <div class="form-group">
                           <label class="col-sm-2 form-text">Trả góp từ  :</label>
                           <div class="col-sm-5">
                              <input type="text" name="caption_1" id="product_price_sale"
                                 data-v-max="9999999999999" data-v-min="0"
                                 class="auto form-control input-sm"
