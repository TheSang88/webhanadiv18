<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/product/categories')?>">Danh sách danh mục sản phẩm</a></li>
						...
						<div class="tab-content">
							...
							<div id="home" class="tab-pane fade in active">
								...
								<div class="form-group">
									...
									<label  class="col-sm-12">Mô tả đầu</label>

									<div class="col-sm-12">

										<textarea id="ckeditor_description" name="mota" class="form-control input-sm" placeholder=""											 rows="4"><?=@$edit->mota;?></textarea>	
										...
										<label  class="col-sm-12" style="margin-top: 20px;">Mô tả cuối</label>

									<div class="col-sm-12">

										<textarea name="description" class="form-control input-sm" placeholder=""											id="ckeditor_detaile_mota" rows="4"><?=@$edit->description;?></textarea>	
									...
									<div class="col-sm-12">
										...
										<textarea name="contents" class="form-control input-sm" placeholder=""											id="ckeditor_detaile" rows="4"><?=@$edit->contents;?></textarea>	
                ...
                <div class="panel panel-default">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-12">
                            	...
                            	<input type="file"  id="download" multiple name="download[]" onchange="preview_download();">
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      CKEDITOR.replace( 'ckeditor_detaile_mota', {
