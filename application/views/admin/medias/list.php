...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/media/categories')?>">Danh mục media</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="<?= base_url('wpadmin/media/add')?>" class="btn btn-success btn-sm">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('wpadmin/media/deletes')?>">
                ...
                <table id="example" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td class="todo-list"><a href="<?= base_url('wpadmin/media/edit/' . $v->id) ?>" title="Sửa sản phẩm">
								...
								<div class="tools">
									...
									<a href="<?= base_url('wpadmin/media/images/' . $v->id) ?>">Thêm ảnh</a>

									<a href="<?= base_url('wpadmin/media/edit/' . $v->id) ?>">Chỉnh sửa</a>

									<a href="<?= base_url('wpadmin/media/delete/' . $v->id) ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?')">Xóa</a>
							...
							<td class="text-center">
								...
								<a class="btn btn-xs btn-default"
								   ...
								   href="<?= base_url('wpadmin/media/images/' . $v->id) ?>"><i class="fa fa-image"></i> </a>

								<a class="btn btn-xs btn-default"

								   href="<?= base_url('wpadmin/media/edit/' . $v->id) ?>"><i

										class="fa fa-pencil"></i> </a>

								<a class="btn btn-xs btn-danger"

								   href="<?= base_url('wpadmin/media/delete/' . $v->id) ?>" title="Xóa"
