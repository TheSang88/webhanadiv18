<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url('wpadmin/media_image/listAll')?>">Danh sách media</a></li>
				...
				<div class="modal-content">
					<div class="panel panel-success" >
						...
						<div style="padding-top:30px" class="panel-body" id="getmodal">
							<div class="row">
								<form action="<?= base_url('wpadmin/media/images/' . $id) ?>" method="post"
									class="validate"
				...
				<tr>
					...
					<td>
						<div class="btn-group btn-group-xs text-center">
							<a href="<?= base_url('wpadmin/media/delete_images/' . $v1->img_id) ?>"
