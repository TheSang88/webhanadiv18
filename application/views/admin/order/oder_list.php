<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('wpadmin/order/orders')?>"> Danh sách đơn hàng</a></li>
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <a href="<?= base_url('wpadmin/order/add')?>" class="hidden btn btn-success btn-sm">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('wpadmin/order/deletes')?>">
						...
						<tr>
							...
							<td class="text-center">
								...
								<a class="btn btn-xs btn-danger"
								   href="<?= base_url('wpadmin/order/delete/' . $v->id) ?>" title="Xóa"
...
<script>
	...
	function update_order_status(sender){
		...
		if(check==true){
			$.ajax({
				type: "POST",
				dataType: "json",
				url: baseurl + 'wpadmin/order/update_order_status',
	...
	function getModal(id) {
		...
		$.ajax({
			type: "GET",
			dataType:"html",
			url: baseurl + 'wpadmin/order/popupdata',
			data: "id=" + id,
