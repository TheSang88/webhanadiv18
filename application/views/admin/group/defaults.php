    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    <li>
                        <i class="fa fa-dashboard"></i> <a href="<?=base_url('wpadmin')?>">Dashboard</a>
                    </li>
                    <li class="active">
            ...
            <div class="col-md-12">
                <div class="text-right" style="padding-bottom: 15px">
                    <a href="<?=base_url('wpadmin/group/add')?>" class="btn btn-success btn-xs">
                ...
                <div class="">
                    <form name="frmGroup" method="post" action="<?=base_url('wpadmin/group/delete')?>">
                        ...
                        <?php foreach($group as $groupArray){ ?>
                            <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>" onmouseover="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,1)" onmouseout="ChangeStyleRow('DivRow_<?php echo $idDiv; ?>',<?php echo $idDiv; ?>,2)">
                                ...
                                <td class="detail_list">
                                    <a class="menu" href="<?php if($groupArray->gro_id == 1 || $groupArray->gro_id == 2 || $groupArray->gro_id == 3 || $groupArray->gro_id == 4){echo '#';}else{ ?><?php echo base_url() ?>wpadmin/group/add/<?php echo $groupArray->gro_id; ?><?php } ?>" title="<?php if($groupArray->gro_id != 1 && $groupArray->gro_id != 2 && $groupArray->gro_id != 3 && $groupArray->gro_id != 4){echo $this->lang->line('edit_tip');} ?>">
                                ...
                                <td class="detail_list" style="text-align:center;">
                                    <?php if($groupArray->gro_status == 1){ ?>
                                        <img src="<?php echo base_url(); ?>assets/img/admin/active.png" onclick="ActionStatus('<?=base_url('wpadmin/group/deactive/'.$groupArray->gro_id)?>')" style="cursor:pointer;" border="0" title="<?php echo $this->lang->line('deactive_tip'); ?>" />
                                    <?php }else{ ?>
                                        <img src="<?php echo base_url(); ?>assets/img/admin/deactive.png" onclick="ActionStatus('<?=base_url('wpadmin/group/active/'.$groupArray->gro_id)?>')" style="cursor:pointer;" border="0" title="<?php echo $this->lang->line('active_tip'); ?>" />
                                    <?php } ?>
                                </td>
                                <td class="detail_list" style="text-align:center;">
                                    <?php echo $groupArray->gro_id; ?>
                                    ...
                                    <!--<a href="<?/*=base_url();*/?>wpadmin/group/add/<?/*=@$groupArray->gro_id*/?>" class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil"></i></a>-->
        ...
        <script type="text/javascript">
            ...
            function changeStatus(id) {
                ...
                $.ajax({
                    type: "POST",
                    data: data,
                    url: "<?=  base_url('wpadmin/users/changeStatusUser')?>",
                    cache: false,
                    dataType: 'json',
                    success: function (e) {
                        if (e) {
