<div class="modal fade bs-example-modal-lg popup1" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
	...
	<div class="modal-dialog modal-lg">
		<?php if(isset($item)){ ?>
		<form class="validate form-horizontal" role="form" id="form-bk" method="POST" action="<?= base_url('wpadmin/admin/edit_showbut/' . $item->id . '') ?>" enctype="multipart/form-data">
			<input type="hidden" name="edit" id="id_edit" value="<?=@$item->id; ?>">
		<?php }else{ ?>
		<form class="validate form-horizontal" role="form" id="form-bk" method="POST" action="<?= base_url('wpadmin/admin/add_showbut/') ?>" enctype="multipart/form-data">
