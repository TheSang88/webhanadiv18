<div id="page-wrapper" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="container-fluid">
        ...
        <div>
                ...
                <form name="frmUser" method="post" action="<?=base_url('wpadmin/user/delete')?>">
                    <tr>
                        <td>
                            <!--BEGIN: Content-->
                                    ...
                                    <?php foreach($user as $userArray){ ?>
                                        ...
                                        <tr style="background:#<?php if($idDiv % 2 == 0){echo 'F7F7F7';}else{echo 'FFF';} ?>;" id="DivRow_<?php echo $idDiv; ?>">
                                            ...
                                            <td class="detail_list">
                                                <a class="menu" href="<?php echo base_url() ?>wpadmin/user/add/<?php echo $userArray->id; ?>" title="<?php echo $this->lang->line('edit_tip'); ?>">
                                            ...
                                            <td class="detail_list" style="text-align:center;">
                                                <?php if($userArray->use_status == 1){ ?>
                                                    <img src="<?php echo base_url(); ?>assets/img/admin/active.png" <?php if($userLogined != $userArray->id){ ?> onclick="ActionStatus('<?=base_url('wpadmin/user/deactive/'.$userArray->id)?>')" style="cursor:pointer;" <?php } ?> border="0" title="<?php echo $this->lang->line('deactive_tip'); ?>" />
                                                <?php }else{ ?>
                                                    <img src="<?php echo base_url(); ?>assets/img/admin/deactive.png" <?php if($userLogined != $userArray->id){ ?> onclick="ActionStatus('<?=base_url('wpadmin/user/active/'.$userArray->id)?>')" style="cursor:pointer;" <?php } ?> border="0" title="<?php echo $this->lang->line('active_tip'); ?>" />
                                                <?php } ?>
                                            </td>
