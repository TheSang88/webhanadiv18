                    ...
                    <div class="panel panel-default fixgiohang" id="cart-content">
                        ...
                        <div class="panel-body giohangfix">
                            <div class="col checkout-cart-list">
                                ...
                                <ul class="checkout-cart-title hidden-xs">
                                ...
                                <ul class="group-cart-product-item" id="cart-list">
                                    <?php foreach($items as $item) : ?>
                                        <li class="cart-product-item col-480-12" data-record-id="<?=$item['rowid']?>">
                                            <ul class="qts_order">
                                                ...
                                                <li class="cart-product-delete  text-center col-480-12">
