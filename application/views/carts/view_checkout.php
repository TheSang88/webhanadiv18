...
<div class="block-content clearfix">
                                        ...
                                        <table class="table table-bordered table-hover orderinfo-table  itemInfo-table">
                                            ...
                                            <?php if(count($items)) : $total=0; ?>
                                                ...
                                                <span>
                                                    ...
                                                    <input type="hidden" value="<?=@$item['rowid'];?>" id="rowid" name="rowid[]" autocomplete="off">
                                                    <span style=" width:50px"><?=@$item['name'];?></span>
                                                    <p >Size: <strong class="text-danger"><?=@$item['size'];?></strong></p>
                                                </td>
                                                <td style="padding-top: 4%;">
                                                    <div class="pro-qty">

                                                        <input name="qty[]" id="quantity" value="<?=@$item['qty'];?>" size="4" title="Qty" class="qty form-control" maxlength="12">
                                                    </div>
    ...
    border-color: rgba(237, 27, 38, 0.01);" title="xóa sản phẩm khỏi giỏ hàng" href="<?=base_url('cart/deleteone?id='.$item['rowid'])?>" class="btn btn-danger btn-xs">
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12">
                            <div class="fix-margin-right thong-tin-don-hang" style="padding-top:0px;">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <strong class="pull-right total-sub" style="font-size: 13px; color: #ea2227;"><?=number_format($this->cart->total())?><?=lang('price_locale');?></strong>
                                </div>
                                <hr>
                                ...
                                <script>
                                       ...
                                       // alert(jQuery(this).val());return false;
                                      //  var qty = $('#txtQty').val();
