...
$route['404_override'] = 'contact/page404';

$route['gui-ctv'] = 'contact/guictv';
//$route['([a-zA-Z0-9_-]+)'] = "home/index/$1";
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
$route['wpadmin/([a-zA-Z0-9_-]+)/([a-zA-Z0-9_-]+)'] = 'admin/$1/$2';
$route['wpadmin/([a-zA-Z0-9_-]+)/([a-zA-Z0-9_-]+)/([a-zA-Z0-9_-]+)'] = 'admin/$1/$2/$3';
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/

$route['wpadmin'] = 'admin/defaults/index';
$route['wpadmin/doi-mat-khau'] = 'admin/admin/admin_change_password';
$route['wpadmin/site_option'] = 'admin/admin/site_option';
$route['wpadmin/huong-dan-su-dung'] = 'admin/admin/documentation';
//Modules=================================================================
$route['wpadmin/danh-sach-modules'] = 'admin/modules/list';
$route['wpadmin/quan-ly-modules'] = 'admin/modules/modulemanager';
$route['wpadmin/edit-modules/(:num)'] = 'admin/modules/modulemanager/$1';
$route['wpadmin/delete-module/(:num)'] = 'admin/modules/delete/$1';

//phan quyen admin
$route['wpadmin/admin-permission'] = 'admin/admin/admin_permission';
$route['wpadmin/admin-permission-edit/(:num)'] = 'admin/admin/admin_permission/$1';
$route['wpadmin/admin-reset-pass/(:num)'] = 'admin/admin/reset_pass/$1';
$route['wpadmin/admin-permission-delete/(:num)'] = 'admin/admin/delete_acc/$1';

// save menu

$route['wpadmin/menu/savelist'] = 'admin/menu/saveList';
...
$route['gio-hang'] = 'muaHang/checkout';

$route['thanh-toan'] = 'muaHang/paymentSave';
$route['onepage'] = 'cart/sendOnpage';
//$route['dat-hang-thanh-cong'] = 'muaHang/order_success';
