    ...
    foreach ($data as $k=>$v) {
        if ($v->parent_id == $parent) {
            ...
            echo "<tr>
                    ...
                    <td>$img</td>
                    <td class=\"text-center\">
                      <a href='".base_url('wpadmin/product_hangsx/Edit/' . $v->id)."'
                    class=\"btn btn-xs btn-default\" title=\"Sửa\"><i class=\"fa fa-pencil\"></i></a>

                <a href='".base_url('wpadmin/product_hangsx/Delete/' . $v->id)."'
                       onclick=\"return confirm('Bạn có chắc chắn muốn xóa?')\"
                       class=\"btn btn-xs btn-danger\"title=\"Xóa\" style=\"color: #fff\"><i class=\"fa fa-times\"></i> </a>
                    </td>
                </tr>";
    ...
    foreach ($data as $k=>$v) {
        if ($v->parent_id == $parent) {
            ...
            echo "<tr>
                    ...
                    <td>$img</td>
                    <td class=\"text-center\">
                      <a href='".base_url('wpadmin/raovat/cat_raovat_edit/' . $v->id)."'
                    class=\"btn btn-xs btn-default\" title=\"Sửa\"><i class=\"fa fa-pencil\"></i></a>

                <a href='".base_url('wpadmin/raovat/cat_raovat_delete/' . $v->id)."'
                       onclick=\"return confirm('Bạn có chắc chắn muốn xóa?')\"
                       class=\"btn btn-xs btn-danger\"title=\"Xóa\" style=\"color: #fff\"><i class=\"fa fa-times\"></i> </a>
                    </td>
                </tr>";
