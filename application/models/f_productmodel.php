...
public function getProdctSizeDetail($id){

    $this->db->select('a.id,a.priceSale,a.priceNiemYet,a.statusSize,b.name');
...
public function getProdctSizeDetailMax($id){

    $this->db->select_max('a.priceSale as priceSale');
    ...
    //return $query->first_row()->priceSale;
...
public function count_ProbyCate_thuonghieu($id)
...
public function count_ProbyCate($id)
    ...
    public function thuonghieu_mod($id, $order, $limit, $offset)
    ...
    // public function get_data($id, $limit, $offset)
